...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col gap-5 items-center mx-auto py-12 ">
      <div className="mt-24">
        ...
        <h1 className="z-10 text-4xl text-transparent duration-1000 bg-white cursor-default text-edge-outline animate-title font-display sm:text-6xl whitespace-nowrap bg-clip-text text-center py-5">
      ...
      <div className="flex flex-col items-center justify-between grow mb-24">
        <div className="text-zinc-200 animate-fade-in">
          <h1 className="text-2xl">New portfolio is coming soon.</h1>
          <p>
